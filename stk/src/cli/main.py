...
app.command(name="last", rich_help_panel=_PANEL_RUNS)(runs.last)
...
app.command(name="routes", rich_help_panel=_PANEL_RUNS)(runs.routes)
app.command(name="map", rich_help_panel=_PANEL_RUNS)(runs.territory_map)
